...
class group:
    def __init__(self, goal_type_ : grouptype, num_credits_or_num_courses : int, courses_ : list, repl_courses_ : dict, unallowed_courses_ : list):
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}({self.goal_type.name}, {self.goal_num}, {self.courses}, {self.repl_courses}, {self.unallowed_courses})')
